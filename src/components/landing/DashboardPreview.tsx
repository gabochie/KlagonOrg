    ...
    <section className="bg-pale py-14 sm:py-16 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-sm text-gray leading-relaxed max-w-[500px] mb-8">
          Track your progress, RSVP to events, join projects, and manage your KlagonStars journey from your
          personal dashboard.
        </p>
        <div className="bg-white rounded-xl border border-border overflow-hidden shadow-sm">
          <div className="bg-navy px-4 sm:px-6 py-3 flex items-center justify-between">
            <span className="text-white text-sm font-bold">KlagonStars Member Dashboard</span>
