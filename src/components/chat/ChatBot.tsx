...
const FAQ: { q: string; a: string }[] = [
  { q: "What is KlagonStars?", a: "KlagonStars is a community-based organization in Klagon, Greater Accra, that prepares youth for the future through skills training, mentorship, entrepreneurship, and community projects — all free of charge." },
  { q: "How do I join?", a: "Click the 'Join KlagonStars' button in the top navigation or visit /auth/register to create your free account. Your membership is reviewed within 24 hours." },
  { q: "Is it really free?", a: "Yes! KlagonStars is 100% free for all youth in Klagon and surrounding communities. There are no fees, no hidden costs, ever." },
  ...
  { q: "Where is KlagonStars located?", a: "We operate at the Community Center in Klagon, Greater Accra Region, Ghana. Most events and workshops are held there." },
...
function getBotReply(userMessage: string): string {
  ...
  if (lower.includes("hello") || lower.includes("hi ") || lower === "hi" || lower === "hey") {
    return "Hey there! 👋 Welcome to KlagonStars. I'm your virtual assistant. Ask me about joining, events, volunteering, mentoring, or anything else about the hub!";
  }
  if (lower.includes("thank")) {
    return "You're welcome! 😊 Anything else I can help you with?";
  }
  if (lower.includes("bye") || lower.includes("goodbye")) {
    return "Goodbye! 👋 Feel free to come back anytime you need help. See you at KlagonStars!";
  }
...
export function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "bot", text: "👋 Hi! I'm the KlagonStars assistant. Ask me anything about KlagonStars — joining, events, volunteering, mentoring, and more!" },
  ]);
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-border w-[360px] max-w-[calc(100vw-40px)] flex flex-col overflow-hidden animate-fade-in">
          <div className="bg-navy px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-sm font-bold text-white">KlagonStars Assistant</div>
