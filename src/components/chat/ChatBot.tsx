...
const FAQ: { q: string; a: string }[] = [
  { q: "What is Klagon Studios?", a: "Klagon Studios is a community-based organization in Klagon, Greater Accra, that prepares youth for the future through skills training, mentorship, entrepreneurship, and community projects — all free of charge." },
  { q: "How do I join?", a: "Click the 'Join Klagon Studios' button in the top navigation or visit /auth/register to create your free account. Your membership is reviewed within 24 hours." },
  { q: "Is it really free?", a: "Yes! Klagon Studios is 100% free for all youth in Klagon and surrounding communities. There are no fees, no hidden costs, ever." },
  ...
  { q: "Where is Klagon Studios located?", a: "We operate at the Community Center in Klagon, Greater Accra Region, Ghana. Most events and workshops are held there." },
  ...
  { q: "How do I contact support?", a: "You can reach us at hello@stars.klagon.org, call +233 24 000 0000, or visit /contact to send us a message. We respond within 24 hours." },
];
...
function getBotReply(userMessage: string): string {
  ...
  if (lower.includes("hello") || lower.includes("hi ") || lower === "hi" || lower === "hey") {
    return "Hey there! 👋 Welcome to Klagon Studios. I'm your virtual assistant. Ask me about joining, events, volunteering, mentoring, or anything else about the hub!";
  }
  if (lower.includes("thank")) {
    return "You're welcome! 😊 Anything else I can help you with?";
  }
  if (lower.includes("bye") || lower.includes("goodbye")) {
    return "Goodbye! 👋 Feel free to come back anytime you need help. See you at Klagon Studios!";
  }
...
export function ChatBot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { role: "bot", text: "👋 Hi! I'm the Klagon Studios assistant. Ask me anything about Klagon Studios — joining, events, volunteering, mentoring, and more!" },
  ]);
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-border w-[360px] max-w-[calc(100vw-40px)] flex flex-col overflow-hidden animate-fade-in">
          <div className="bg-navy px-4 py-3 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="text-sm font-bold text-white">Klagon Studios Assistant</div>
