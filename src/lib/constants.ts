...
export const EVENTS: Event[] = [
  ...
  { id: "2", title: "Klagon Problem-Solving Hack", type: "hackathon", date: "2025-07-19", time: "9:00 AM", location: "KLAGON.org Hub", spots: 25, spotsLeft: 13, rsvpCount: 12 },
...
export const TESTIMONIALS = [
  { quote: "\"Before KLAGON.org, I didn't know where to start. After three sessions, I landed my first freelance design job. It's the best thing to happen to Klagon youth.\"", name: "Ebenezer Ofori", role: "Graphic Designer, Age 22", initials: "EO", color: "#0F1B5C" },
...
export const MEMBER_EVENTS: Event[] = [
  ...
  { id: "2", title: "Klagon Hackathon", type: "hackathon", date: "2025-07-19", time: "9:00 AM", location: "KLAGON.org Hub", spots: 25, spotsLeft: 13, rsvpCount: 12 },
  { id: "3", title: "Public Speaking & Influence", type: "leadership", date: "2025-07-23", time: "5:00 PM", location: "Community Hall", spots: 0, spotsLeft: 0, rsvpCount: 0 },
];
...
export const ANNOUNCEMENTS: Announcement[] = [
  ...
  { id: "3", title: "Mentor Kweku Asante is available", body: "Software engineer and KLAGON.org mentor Kweku just opened 3 slots for 1-on-1 sessions this month.", time: "2 days ago", dotColor: "#1A2E8C" },
];
...
export const VOLUNTEER_OPPS: VolunteerOpportunity[] = [
  ...
  { id: "2", title: "Event Coordinator", description: "Help plan, organize, and run KLAGON.org workshops, hackathons, and community events throughout the month.", icon: "📅", category: "Events", commitment: "3-5 hrs/week", spots: 5, spotsLeft: 3, color: "#FFF7E6" },
  ...
  { id: "4", title: "Social Media Lead", description: "Manage KLAGON.org' social media presence — create content, share updates, and grow our online community.", icon: "📱", category: "Communications", commitment: "3 hrs/week", spots: 3, spotsLeft: 2, color: "#FFF3F0" },
  ...
  { id: "6", title: "Fundraising Assistant", description: "Help with grant research, donor outreach, and fundraising campaigns to support KLAGON.org programs.", icon: "💰", category: "Operations", commitment: "3 hrs/week", spots: 4, spotsLeft: 4, color: "#F0FDF4" },
];

export const NEWS_ARTICLES: NewsArticle[] = [
  { id: "1", title: "KLAGON.org Launches New Career Planning Course for Klagon Youth", excerpt: "A brand new 5-lesson career roadmap course has just launched, designed to help young people in Klagon plan their professional futures with confidence.", category: "Programs", author: "Emmanuel Kumi", date: "10 Jul 2025", image: "📋", readTime: "3 min" },
  ...
  { id: "3", title: "Mentor Spotlight: Kweku Asante Opens 1-on-1 Sessions", excerpt: "Software engineer and KLAGON.org mentor Kweku Asante has opened 3 new slots for personalized mentoring sessions this month.", category: "Community", author: "KLAGON.org Team", date: "6 Jul 2025", image: "🌟", readTime: "4 min" },
  ...
  { id: "5", title: "Digital Literacy Program Expands to Senior Citizens", excerpt: "Following high demand, KLAGON.org is expanding its Digital Literacy program with dedicated sessions for senior residents of Klagon.", category: "Programs", author: "Mary Acheampong", date: "1 Jul 2025", image: "💻", readTime: "3 min" },
  { id: "6", title: "KLAGON.org Partners with Action Aid Ghana for Youth Workshop Series", excerpt: "A new partnership brings resources, mentorship, and funding for a series of workshops focused on entrepreneurship and life skills.", category: "Partnerships", author: "Emmanuel Kumi", date: "28 Jun 2025", image: "🤝", readTime: "5 min" },
];
